...
export default new Command('addsound', `${ constants.messagePrefix } addsound`, 'Used as the comment with a sound file attachment', execFunc, { serverOnly: true, requiredPermission: Discord.Permissions.FLAGS.MANAGE_GUILD });
